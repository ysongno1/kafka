...
public class MyProducerCallbackKey {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            ProducerRecord<String, String> myProducerRecord = new ProducerRecord<String, String>("second", "abc","Kafka" + i);
